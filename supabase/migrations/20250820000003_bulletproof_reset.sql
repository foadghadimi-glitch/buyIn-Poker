-- BULLETPROOF DATABASE RESET - COMPLETE CLEAN SLATE
-- This script will completely destroy and recreate your database
-- WARNING: This will delete EVERYTHING in your database!

-- 1. DISABLE ALL TRIGGERS AND CONSTRAINTS FIRST
DO $$
DECLARE
    r RECORD;
BEGIN
...
-- 2. DROP EVERYTHING - NO MERCY
DROP SCHEMA IF EXISTS public CASCADE;
CREATE SCHEMA public;
GRANT ALL ON SCHEMA public TO postgres;
GRANT ALL ON SCHEMA public TO public;

-- 3. RECREATE THE PLAYERS TABLE (User Profiles)
...
-- 4. RECREATE THE POKER_TABLES TABLE (Game Tables)
...
-- 5. RECREATE THE TABLE_PLAYERS TABLE (Players in Tables)
...
-- 6. RECREATE THE BUY_INS TABLE (Buy-in Transactions)
...
-- 7. RECREATE THE BUY_IN_REQUESTS TABLE (Buy-in Requests)
...
-- 8. RECREATE THE JOIN_REQUESTS TABLE (Join Requests)
...
-- 9. RECREATE THE TABLE_ENDUPS TABLE (Final Amounts)
...
DO $$
BEGIN
    RAISE NOTICE '=== BULLETPROOF DATABASE RESET COMPLETED ===';
